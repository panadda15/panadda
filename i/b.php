...
?>   
    <tr>
        ...
        <td width="80" align="center"><a href="delete_provinces.php?id=<?php echo $data['r_id']; ?>" onClick="return confirm('ยืนยันการลบ');"><img src="images/delete.jpg" width="140"></a></td>
    </tr>
<?php } ?>
</table>
